...
public interface IBrainButlerCommand
{
   ...
   /// <returns>A natural language response about the action outcome, or null if something goes wrong.</returns>
   ValueTask<string?> ExecuteAsync(string userPrompt, string? inputPrompt);
}
