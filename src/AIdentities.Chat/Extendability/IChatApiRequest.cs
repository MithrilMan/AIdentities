...
public interface IChatApiRequest
{
   ...
   /// </summary>
   float RepetitionPenality { get; set; }
   ...
   float RepetitionPenalityRange { get; set; }
   ...
   /// </summary>
   float TailFreeSampling { get; set; }
