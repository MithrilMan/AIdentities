...
/// </summary>
public record InvalidPromptThought : Thought
{
   public InvalidPromptThought(Guid? SkillActionId, AIdentity AIdentity)
      : base(SkillActionId, AIdentity.Id, "I couldn't extract a proper JSON object from the prompt to extract arguments I need.")
   {
   }
}
